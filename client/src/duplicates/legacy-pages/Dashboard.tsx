          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8 text-gray-500">
                ...
                <p>AI Triage system coming soon...</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8 text-gray-500">
                ...
                <p>Client intake system coming soon...</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="admin" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Administrative tools and oversight</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8 text-gray-500">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-8 text-gray-500">
            ...
            <p>AI reasoning system coming soon...</p>
            <div className="mt-4 text-xs text-gray-400">
              Real-time document processing and legal reasoning will be available in future updates
            </div>
          </div>
        </CardContent>
      </Card>
